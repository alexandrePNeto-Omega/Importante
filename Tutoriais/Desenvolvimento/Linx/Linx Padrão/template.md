...
POSTOSAS3-15646: Assinatura Digital - Venda e exportação dos dados

# --- Descrição --- # Sempre coloque o impacto final

Efetuado ajustes e melhorias nas rotinas da assintura digital como geração de faturas, envio de assinaturas por e-mail, e finalização da venda.
...
**Problema**
 - Erro na geração de fatura com assinatura digital, quando existe uma assinatura em .pdf no banco de dados. Impacto PR: XXXXX
 - Erro no envio de email e exportação da assinatura digital. Impacto PR: XXXXX
 - Tela de solicitação de assinatura, abrindo múltiplas vezes no PDV, quando um cliente está com mais de uma regra de conta configura na politica comercial para mais de uma empresa.
...
**Procedimentos**
 - Geração de faturas, Envio de assinturas:
    - Realizar vendas da assinatura digital em uma versão inferior as 3.3.1.120, gerando assinaturas de .pdf, em seguida realizar vendas em uma versão recente(Acima da 3.3.1.130) para que sejam geradas assinaturas em .png. Realizar faturamento desses registros e envio por e-mail.
 - Regras do cliente:
...
No devazure, pode criar uma PR e colocar as coisas lá
